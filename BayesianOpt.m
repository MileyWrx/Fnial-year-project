...
% % % MODIFY % % %
fun_name = 'Ackley';
dimension = 20;% Sixhump 2,Sasena 2,Ellipsoid 10,Rosenbrock 20,Ackley 20
lower_bound = -32.768 * ones(1,20);
upper_bound = 32.768 * ones(1,20);
% % % % % % % % % %
% num_test = 1000;
...
for i = 1: 10
    ...
    time(i) = toc;
    % test_prediction = predictor(sample_x,GP_model);% 预测值
    final_min(i) = fmin;
    % RMSE(i) = sqrt(sum((test_prediction - sample_y).^2)/num_test);
end
